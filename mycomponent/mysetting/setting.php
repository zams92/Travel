...
$aksi="mycomponent/mysetting/proses.php";

$availableAdTheme = array("clean", "amethyst", "autumn", "fancy", "fire", "flatie", "modern", "night", "spring");
$localAdTheme = $_COOKIE['System_AdTheme'];
...
?>
	<div class="content-header">
		<div class="header-section">
            <h1><i class="fa fa-cogs"></i> <?=$langsetting1;?></h1>
        </div>
	</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="block full">
            <div class="block-title">
                ...
                <h2>Menagement Website <small><?=$langsetting10;?></small></h2>
           </div>
            <?php
                $tablesetting = new MyTable('setting');
                $currentSetting = $tablesetting->findBy(id_setting, '1');
                $currentSetting = $currentSetting->current();
            ?>
           <div class="block-content">
            <div class="table-responsive">
                <table class="table table-vcenter table-hover" cellpadding="0" cellspacing="0">
                    <thead><tr><th style="width:30%;"><?=$langsetting3;?></th><th><?=$langsetting4;?></th></tr></thead>
                    <tbody>
                    <tr>
                        <td><?=$langsetting5;?></td>
                        <td>
    ...
    <div class="col-md-12">
        <div class="block full">
            ...
            <?php
                $tableoauthfb = new MyTable('oauth');
                    ...
                    <tr>
                        <td colspan="2">
                            <form method="post" action="<?=$aksi;?>" autocomplete="off">
                                ...
                                <a class="btn btn-sm btn-primary" href="mycomponent/myoauth/facebook/index.php"><i class="fa fa-facebook"></i> New Or Renew OAuth</a>
		...
		<?php
			$tableoauthtw = new MyTable('oauth');
                    ...
                    <tr>
                        <td colspan="2">
                            <form method="post" action="<?=$aksi;?>" autocomplete="off">
                                ...
                                <a class="btn btn-sm btn-primary" href="mycomponent/myoauth/twitter/index.php"><i class="fa fa-twitter"></i> New Or Renew OAuth</a>
                                <button class="btn btn-sm btn-danger" type="submit"><i class="fa fa-times"></i> Delete OAuth</button>
                            </form>
                        </td>
                    </tr>
...
<div class="clearfix"></div>
    <?php
    $filename_meta = "mycomponent/mysetting/meta-social.txt";
    ...
    <div class="block full">
		<div class="block-title">
            <div class="block-options pull-right">
                <i class="fa fa-desktop"></i> FullScreen<em><b> (F11)</b> </em>
            </div>
