...
if($currentRoleAccess->read_access == "Y"){
    ...
    $aColumns = array( 'id_user', 'email', 'username', 'nama_lengkap', 'tgl_daftar', 'no_telp' );
    ...
    while ( $aRow = mysql_fetch_array( $rResult ) )
    {
        ...
        {
            $filename = "../myuser/user-$aRow[id_user].jpg";
            if (file_exists($filename)){
                $picture = "<div class='text-center'><img src='../myuser/user-$aRow[id_user].jpg' alt='avatar' class='widget-image img-circle' style='width:70px; border:1px solid #ccc;'/>";
            }else{
            ...
            if($_SESSION['leveluser'] == '1'){
                if($currentRoleAccess->modify_access == "Y"){
                    $tblheadline = "<a class='btn btn-xs btn-default setheadline' id='$aRow[id_user]'><i class='fa fa-star'></i></a>";
                }
            }
			...
			$row[] = "<div class='text-center'><div class='btn-group btn-group-xs'>
            <a class='btn btn-xs btn-default' href='admin.php?mod=user&act=view&id=$aRow[id_user]' id='$aRow[id_user]'><i class='fa fa-eye'></i></a>
