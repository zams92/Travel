...
$aksi="mycomponent/mymarketing/proses.php";
?>
...
switch($_GET[act]){
            ...
            <div class="col-md-12">
                    <div class="block full">
                        ...
                        <?php
                            ...
                            $users = $tableuser->findAll(KodeMarketing, DESC);
                            echo "<table cellpadding='0' cellspacing='0' border='0' class='table table-vcenter table-condensed table-bordered' id='table-datatable'>
                                <thead><tr>
                                    ...
                                    <th class='text-center'style='font-size: 13px;'>Level</th>
                                    <th class='text-center'style='font-size: 13px;'>Action</th>
                                </tr></thead>"; 
                                $no=1;
                                foreach($users as $user){
                                    $tablelevel = new MyTable('tblmarketing');
                                    $currentLevel = $tablelevel->findBy(KodeMarketing, $user->KodeMarketing);
                                    ...
                                    echo "<tr>
                                        ...
                                        <td class='text-center'>
                                            <div class='text-center'><div class='btn-group btn-group-xs'>
                                               <a href='administrasi.php?mod=marketing&act=view&id=$user->KodeMarketing' data-placement='left' class='enable-tooltip btn btn-xs btn-default'  title='View'><i class='fa fa-list'></i></a>
											   <a data-placement='left' class='enable-tooltip btn btn-xs btn-default alertdeljabatan' id='$user->KodeMarketing' title='Edit'><i class='fa fa-pencil'></i></a>
											   <a data-placement='right' class='enable-tooltip btn btn-xs btn-danger alertdel' id='$user->KodeMarketing' title='Delete'><i class='fa fa-times'></i></a>
                                            </div></div>
                                        </td>
                                    </tr>";
                                    $no++;
    ...
    <?php
                        ...
                        <?php
                            ...
                            echo "<table cellpadding='0' cellspacing='0' border='0' class='table table-vcenter table-condensed table-bordered' id='table-datatable'>
                                <thead><tr>
                                    ...
                                    <th class='text-center'style='font-size: 13px;'>Status</th>
                                    <th class='text-center'style='font-size: 13px;'>Level</th>
                                    <th class='text-center'style='font-size: 13px;'>IDReferal</th>
                                    <th class='text-center'style='font-size: 13px;'>Action</th>
                                </tr></thead>"; 
                                $no=1;
                                foreach($users as $user){
		...
		<?php
        } elseif ($_SESSION[hakakses]=='Perwakilan' OR $_SESSION[hakakses]=='Marketing'){
		?>
		<div class="row">
            <div class="col-md-12">
                    <div class="block full">
                        ...
                        <?php
                            ...
                            $users = $tableuser->findByASC(IDPerwakilan,$_SESSION['idrekanan'],KodeMarketing);
							}
							else{
                            $users = $tableuser->findByASC(IDReferal,$_SESSION['idrekanan'],KodeMarketing);	
							}
                            echo "<table cellpadding='0' cellspacing='0' border='0' class='table table-vcenter table-condensed table-bordered' id='table-datatable'>
                                <thead><tr>
                                    <th class='text-center'style='font-size: 13px;'>ID</th>
			...
			<div class="modal-content">
				<form id="form-validation" class="form-horizontal" method="post" action="<?=$aksi;?>" autocomplete="off">
					...
					<div class="modal-body">
						<input type="hidden" name="mod" value="marketing">
						<input type="hidden" name="act" value="deletemarketing">
...
<?php
	...
	$table = new MyTable('tblmarketing');
	$currentUser = $table->findBy(KodeMarketing, $valid);
...
?>
	<div class="block">
        <div class="block-title">
            <h2><strong>Edit</strong> Marketing</h2>
        </div>
        <div class="row">
            <div class="col-sm-14 ">
            <div class="col-sm-7">
		      <form id="form-validation" class="form-horizontal" method="post" action="<?=$aksi;?>" autocomplete="off">
                <fieldset>
                    ...
                    <input type="hidden" name="kodemarketing" value="<?=$currentUser->KodeMarketing; ?>">
                    <input type="hidden" name="mod" value="marketing">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                        <input class="form-control" type="text" id="idper" name="idper"  value="<?=$currentUser->IDMarketing; ?>" readonly required>
                        </div>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <div class="col-md-8">
                        <input class="form-control" type="text" id="level" name="level" maxlength=15 onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value="<?=$currentUser->Level; ?>" required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-4 control-label">ID Referal <span class="text-danger">*</span></label>
                        <div class="col-md-8">
                           <input class="form-control" type="text" id="idreferal" name="idreferal" value="<?=$currentUser->IDReferal; ?>" required>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-4 control-label">ID Perwakilan <span class="text-danger">*</span></label>
                        <div class="col-md-8">
                           <input class="form-control" type="text" id="idperwakilan" name="idperwakilan" value="<?=$currentUser->IDPerwakilan; ?>" required>
                        </div>
                    </div>
                    <div class="form-group">
...
?>
	<div class="block">
        <div class="block-title">
            <h2><strong>View</strong>  Data Marketing</h2>
        </div>
        <div class="row">
            <div class="col-sm-14 ">
            <div class="col-sm-7">
		      <form id="form-validation" class="form-horizontal" method="post" action="<?=$aksi;?>" autocomplete="off">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">ID <span class="text-default">:</span></label>
                        <div class="col-md-8">
                        <input class="form-control" type="text" id="idper" name="idper"  value="<?=$currentUser->IDMarketing; ?>" readonly >
                        </div>
                    </div>
                    <div class="form-group">
					...
					<div class="form-group">
                        <label class="col-md-4 control-label">Level <span class="text-default">:</span></label>
                        <div class="col-md-8">
                        <input class="form-control" type="text" id="level" name="level" maxlength=15 onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value="<?=$currentUser->Level; ?>" readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-4 control-label">ID Referal <span class="text-default">:</span></label>
                        <div class="col-md-8">
                           <input class="form-control" type="text" id="idreferal" name="idreferal" value="<?=$currentUser->IDReferal; ?>" readonly>
                        </div>
                    </div>
					<div class="form-group">
                        <label class="col-md-4 control-label">ID Perwakilan <span class="text-default">:</span></label>
                        <div class="col-md-8">
                           <input class="form-control" type="text" id="idperwakilan" name="idperwakilan" value="<?=$currentUser->IDPerwakilan; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group">
