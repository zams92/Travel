		...
		<div class="row">
			<div class="col-md-8 ul-menu">
				<ul id="menu-group">
					...
					<?php endforeach; ?>
					<li id="add-group"><a href="#" title="Add Menu Group">+ Add</a></li>
				</ul>
			</div>
			<div class="clearfix"></div>
			<div class="col-md-8 ul-menu">
				<form method="post" id="form-menu" action="mycomponent/mymenumanager/proses.php?mod=menu&act=save_position">
			...
			<div class="col-md-4">
				...
				<div class="box">
					<h2>Add Menu</h2>
					<section>
						<form id="form-add-menu" method="post" action="mycomponent/mymenumanager/proses.php?mod=menu&act=add">
