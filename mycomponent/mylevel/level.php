...
$aksi="mycomponent/mylevel/proses.php";
?>
        ...
        <div class="row">
            <div class="col-md-12">
                    <div class="block full">
                        ...
                        <?php
                            $tableuser = new MyTable('tbllevel');
                            $users = $tableuser->findAll(NamaLevel, DESC);
                            echo "<table cellpadding='0' cellspacing='0' border='0' class='table table-vcenter table-condensed table-bordered' id='table-datatable'>
                                ...
                                foreach($users as $user){
                                    echo "<tr>
                                        <td>$user->NamaLevel</td>
                                        <td>$user->Komisi</td>
                                        <td>$user->Keterangan</td>
                                        <td class='text-center'>
                                            <div class='text-center'><div class='btn-group btn-group-xs'>
                                               <a data-placement='left' class='enable-tooltip btn btn-xs btn-default alertdeljabatan' id='$user->NamaLevel' title='Edit'><i class='fa fa-pencil'></i></a>
											   <a data-placement='right' class='enable-tooltip btn btn-xs btn-danger alertdel' id='$user->NamaLevel' title='Delete'><i class='fa fa-times'></i></a>
                                            </div></div>
                                        </td>
                                    </tr>";
                                    $no++;
