...
var TablesDatatables = function () {
    return {
        init: function () {
			...
			var oTable = $("#table-datatable").dataTable();
			oTable.$(".alertver").click(function(){
				var id = $(this).attr("id");
				$('#alertver').modal('show');
				$('#verid').val(id);
			});
...
$("#uploader").pluploadQueue({
	...
	filters : [/*
		...
		{title: "Video Files", extensions: "flv"},
		{title: "Video Files", extensions: "avi"},
		{title: "Audio Files", extensions: "mp3"}
	]
});

$("#browse-file").attr('href', 'js/plugins/filemanager2/index.html?integration=custom&type=image&txtFieldId=picture');
