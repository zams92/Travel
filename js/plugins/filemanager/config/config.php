...
$strlink_po = preg_replace("/\/myadmin\/js\/plugins\/filemanager\/(dialog\.php$)/","",$str_po);
...
$upload_dir = $strlink_po."/mycontent/myupload/".$_SESSION['iduser']."/"; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../mycontent/myupload/'.$_SESSION['iduser'].'/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../mycontent/mythumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
