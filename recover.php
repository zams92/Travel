                ...
                <div class="col-md-5 col-md-offset-1">
                    <div id="login-alt-container">
                        <h1 class="push-top-bottom">
                            <i class="gi gi-flash"></i> <strong>Welcome </strong>
                        ...
                        <footer class="push-top-bottom" style="color:#ddd;
    opacity: 0.75;">
                            <small><span id="year-copy"></span> &copy; <a href="#" target="_blank" style="color:#fff;
    text-decoration:none; !important;"> Boedy</a></small>
                        </footer>
                        <!-- END Footer -->
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <p class="text-center remove-margin">
                                <a href="register.php" id="link-reg"><small>Create one Account!</small></a><br>
                            </p>
                            <?php } ?>
                            <p class="text-center remove-margin">
